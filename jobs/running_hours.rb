...
# THIS JOB HAS BEEN TURNED OFF FOR NOW.
# - it might work better as a report.

# # FOR TESTING...
# condition = ENV['TEST_DASH'] ? "'2017-10-06 10:00'" : 'localtimestamp'
#
# query = <<~HTML
...
#   WHERE #{condition} BETWEEN shifts.start_date_time AND shifts.end_date_time
